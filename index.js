...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n'  ONIMARU BOT
            + 'TEL;type=CELL;type=VOICE;waid=6285784880291:+62 857-8488-0291\n'  TERSERAH MAU GANTI ATAU TIDAK TAPI KALAU EROR JANGAN SALAHKAN W
            + 'END:VCARD' 
prefix = '#' TERSERAH LU
blocked = []          
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+6285784880291@s.whatsapp.net"] NOMOR WA LU
          ...
          case 'ping':
            ...
            break
                ...
                case 'bug':
                    ...
                    client.sendMessage('6285784880291@s.whatsapp.net', options, text, {quoted: mek}) NOMOR WA LU
				...
				case 's':
					...
					break
				case 'getses':
            	if (!isOwner) return reply(mess.only.ownerB) JANGAN GANTI NANTI EROR 
            ...
            break	
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB) TERSERAH KALAU EROR JANGAN SALAHKAN W ATAU JANGAN DI GANTI SAJA
					prefix = args[0]
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						for (let _ of mentioned) {
							teks += `𝘆𝗮𝗵𝗵 𝗷𝗮??𝗮𝘁𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 𝗸??𝗺?? 𝘀𝘂𝗱𝗮𝗵 𝗱𝗶 𝗰𝗼𝗽𝗼𝘁🏃 :\n`
							teks += `@_.split('@')[0]`
						}
